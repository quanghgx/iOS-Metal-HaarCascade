...
class HaarCascade {
    ...
    func getBuffers() -> Buffers {
        ...
        encoder.setBytes(&numberOfClassifiers, length: MemoryLayout<Int>.size, index: 0)
        encoder.setBuffer(scaledHaarClassifiersBuffer, offset: 0, index: 1)
        encoder.setBuffer(scaledHaarClassifiersGPUBuffer, offset: 0, index: 2)
